...
function EditarPunto() {
  ...
  const handleMouseMove = (e) => {
    ...
    const walkX = (x - startX) * 0.3; // Multiplicar por 2 para hacer el movimiento más rápido
      ...
      <div className="main-content">
        {isLoading ? (
          ...
          <>
            ...
            >
              <div className="contenidoMapa">
                <div
                  className="punto"
                  style={{
                    top: coordenadasObj.top,
                    left: coordenadasObj.left,
            ...
            <button className="save-btn-point" type="submit" form="editForm">
              Guardar
            </button>
            <hr />
            <form id="editForm" onSubmit={handleSubmit} className="edit-form">
              <div className="input-row">
                <div className="input-field">
                  <label className="input-titles-edit-usuario">
                    Nombre en español:
                  </label>
                  <input
                    type="text"
              ...
              <div className="input-row">
                <div className="input-field">
                  ...
                  <textarea
                    type="text"
                    name="descripcion_eng"
                    value={descripcion_eng}
                    onChange={handleChange}
                    className="edit-multi-input"
                  />
                </div>
